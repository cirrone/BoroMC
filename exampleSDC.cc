...
int main(int argc,char** argv)
{
  ...
  //
  runManager->SetUserInitialization(new SDCDetectorConstruction);
  //
  runManager->SetUserInitialization(new SDCPhysicsList);
    
  // Set user action initialization
  //
  runManager->SetUserInitialization(new SDCActionInitialization());  
