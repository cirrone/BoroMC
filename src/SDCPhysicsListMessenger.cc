...
SDCPhysicsListMessenger::SDCPhysicsListMessenger(SDCPhysicsList* pPhys)
...
SDCPhysicsListMessenger::~SDCPhysicsListMessenger()
{
    delete fGammaCutCmd;
    delete fElectCutCmd;
    delete fPosCutCmd;
...
void SDCPhysicsListMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
